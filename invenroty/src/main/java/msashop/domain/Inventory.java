...
import msashop.domain.InventoryIncresed;
...
public class Inventory {
    ...
    public static InventoryRepository repository() {
        InventoryRepository inventoryRepository = InvenrotyApplication.applicationContext.getBean(
    ...
    public static void descreseInventory(DeliveryStarted deliveryStarted) {
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void descreseInventory(OrderPlaced orderPlaced) {
        //implement business logic here:
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void increseDelivery(DeliveryCanceled deliveryCanceled) {
        //implement business logic here:
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void increseDelivery(OrderCanceled orderCanceled) {
        //implement business logic here:
